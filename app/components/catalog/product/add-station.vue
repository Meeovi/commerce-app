                    ...
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-file-input @change="handleImageUpload" clearable density="compact"
                                prepend-icon="fas:fa fa-image" accept="image/*" label="Image" variant="solo-inverted" />
                        </v-col>
                        
                        <v-col cols="12">
                            <v-file-input @change="handleMediaUpload" chips multiple clearable density="compact"
                                prepend-icon="fas:fa fa-video" accept="video/*" label="Live Video" variant="solo-inverted">
                            </v-file-input>
                        </v-col>
                        <v-col cols="12">
                            <v-file-input @change="handleAudioUpload" chips multiple clearable density="compact"
                                prepend-icon="fas:fa fa-microphone" accept="audio/*" label="Audio" variant="solo-inverted">
                            </v-file-input>
                        </v-col>
                    </v-row>
                </v-card-text>
...
<script setup>
    ...
    import createStation from '~/app/composables/stations/createStation';
    import {
    useUserStore
  } from '~/stores/user'
