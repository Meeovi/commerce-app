        ...
        <v-dialog v-model="dialog" :scrim="false" transition="dialog-bottom-transition">
            <template v-slot:activator="{ props }">
                <v-btn v-bind="props" class="rightAddBtn">
                    <v-icon start icon="fas:fa fa-plus"></v-icon>Add Coupon
                </v-btn>
            </template>
            <v-card>
                <form>
...
<script setup>
    ...
    const wordpressUrl = config.public.wordpressUrl || 'https://meeovi.meeovicms.com';
    const wordpressToken = config.public.wordpressToken || ''
